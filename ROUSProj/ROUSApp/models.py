...
class PartMaintenance(models.Model):
    ...
    PlaneSN = models.ForeignKey(PlaneData, related_name='PartMaintenance', on_delete=models.CASCADE)
    MDS = models.ForeignKey(PlaneData, related_name='MDSs', on_delete=models.CASCADE)
